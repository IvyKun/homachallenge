...
namespace StylizedWaterShader
{
    ...
    public static class TexturePacker
    {
        ...
        public static Texture2D RenderShaderMap(Material targetMaterial, int intersectionStyle, int waveStyle, int heightmapStyle, bool useCompression = false, Texture2D customIntersectionTex = null, Texture2D customHeightmapTex = null)
        {
            ...
            {
                if(r.intersectionStyles[intersectionStyle] == null)
                {
                    Debug.LogError("Intersection texture at index " + intersectionStyle + " is missing", r);
            ...
            {
                if (r.heightmapStyles[heightmapStyle] == null)
                {
                    Debug.LogError("Heightmap texture at index " + heightmapStyle + " is missing", r);
                    return Texture2D.blackTexture;
                }
